 ...
 */
object AppConfig {
    const val ANG_PACKAGE = "com.tinypanda.vpn"
    ...
    const val DNS_AGENT = "dns.google"
    const val DNS_DIRECT = "223.5.5.5"

    const val PORT_LOCAL_DNS = "10853"
    const val PORT_SOCKS = "10808"
    const val PORT_HTTP = "10809"
    const val MSG_SERVER_SELECTED = 70
    const val MSG_SERVER_IMPORT = 73
    ...
    const val MSG_MEASURE_UPDATE_SUBS = 74
    const val MSG_MEASURE_SELECT_CONFIG = 75
}
