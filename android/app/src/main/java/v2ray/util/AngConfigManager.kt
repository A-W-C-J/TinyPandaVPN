...
import sail.AppConfig.ANG_CONFIG
import sail.AppConfig.HTTPS_PROTOCOL
import sail.AppConfig.HTTP_PROTOCOL
import v2ray.extension.idnHost
import v2ray.dto.*
import v2ray.dto.V2rayConfig.Companion.DEFAULT_SECURITY
import v2ray.dto.V2rayConfig.Companion.TLS
import v2ray.util.MmkvManager.KEY_SELECTED_SERVER
import java.net.URI
import java.util.*
        ...
        try {
            ...
            return config.configType.protocolScheme + when (config.configType) {
                EConfigType.VMESS -> {
                    ...
                    vmessQRCode.alpn = Utils.removeWhiteSpace(streamSetting.tlsSettings?.alpn?.joinToString())
                        .orEmpty()
                ...
                EConfigType.TROJAN -> {
                    ...
                    (streamSetting.tlsSettings?: streamSetting.realitySettings)?.let { tlsSetting ->
                        ...
                        if (!tlsSetting.alpn.isNullOrEmpty() && tlsSetting.alpn.isNotEmpty()) {
                            dicQuery["alpn"] = Utils.removeWhiteSpace(tlsSetting.alpn.joinToString())
                                .orEmpty()
                        }
