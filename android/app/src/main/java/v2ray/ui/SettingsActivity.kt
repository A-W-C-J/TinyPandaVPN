...
import v2ray.ang.viewmodel.SettingsViewModel
...
class SettingsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.sail_tunnel.sail.R.layout.activity_settings)

        title = getString(com.sail_tunnel.sail.R.string.title_settings)
...
//        val tgGroup: Preference by lazy { findPreference(PREF_TG_GROUP) }
        ...
        override fun onCreatePreferences(bundle: Bundle?, s: String?) {
            addPreferencesFromResource(com.sail_tunnel.sail.R.xml.pref_settings)
...
//            }
            ...
            mode?.dialogLayoutResource = com.sail_tunnel.sail.R.layout.preference_with_help_link
